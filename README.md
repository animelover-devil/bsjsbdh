![Yumeko Jabami](https://wallpapercave.com/w/uwp910848.jpg) 
# yunekojabami
...
Originally a Marie fork, JungKook evolved further and was built to be more robust and more dedicated to K-POP Chats. 

Can be found on telegram as [JungKookRobot](https://t.me/JungKookRobot).

The Support group can be reached out to at [JungKookSupport](https://t.me/JungkookSupportGroup), where you can ask for help about [JungKook](https://t.me/Jungkooksupportgroup),discover/request new features, report bugs, and stay in the loop whenever a new update is available. 
