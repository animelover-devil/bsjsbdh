...
Originally a Marie fork, Yumeko evolved further and was built to be more robust and more dedicated to anime Chats. 

Can be found on telegram as [Yumeko Jabami](https://t.me/yumekojabami_robot).

The Support group can be reached out to at [Yumeko Jabami support group](https://t.me/joinchat/rvxXOaWuVjVmNzE9), where you can ask for help about [Yumeko Jabami](https://t.me/joinchat/rvxXOaWuVjVmNzE9),discover/request new features, report bugs, and stay in the loop whenever a new update is available. 
